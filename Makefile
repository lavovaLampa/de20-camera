...
targets = sdram_init_ctrl ccd_ctrl img_convolution i2c_ccd_config i2c_ctrl sdram_ctrl ccd_demosaic data_ctrl ccd_pixel_pipeline fifo vga_ctrl reset_ctrl
